...
\textbullet{Concurrent scraping live odds and scores $\sim$500 games/day on Linux virtual machines}\\
...
\begin{itemize}
\item \textbf{Tools:} pytorch, gym, spinningup, go
\end{itemize}
\begin{itemize}
\item \textbf{Link :} github.com/anandijain/sips /sipgo /gym-sips 
\end{itemize}
...
\begin{itemize}
\item \textbf{Tools:} pytorch, torchvision, tkinter 
\end{itemize}
\begin{itemize}
