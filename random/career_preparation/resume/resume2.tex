...
\textbullet{Agent learns to hedge across time and returns a positive reward on test set}
...
\textbullet{Todo: Make sequential embedding from one audio segment to the next using LSTM}
\begin{itemize}
