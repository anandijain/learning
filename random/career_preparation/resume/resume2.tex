...
\textbullet{Abstract Linear Algebra}
\textbullet{Algorithms}
\textbullet{Computer Systems}
\textbullet{Discrete Math}
\textbullet{Electronics}
\textbullet{Interactive Devices}
\textbullet{Mathematical Logic}
\textbullet{Molecular Engineering}
\textbullet{Quantum Computation}

%-------------------------------------------------------------------------------
%	COMPUTER SKILLS SECTION
%-------------------------------------------------------------------------------
\section{SKILLS}
\textbf{Languages:} Python, Go, Rust, Julia, Bash, C/C++, MySQL, \LaTeX\\
\textbf{Packages:} PyTorch, Gym, TensorFlow, DiffEq.jl, Pandas, Flask \\
...
\textbullet{Currently porting scraper to Rust\\}
\textbf{tools:} pytorch, gym, spinningup, go\\
\textbf{src :} github.com/anandijain/sips (/sipgo $=>$ /sipoxide) and /gym-sips
...
\textbf{myquantum: the quantum learners repo}\\ 
\textbullet{Wrote basic quantum math package in Julia to learn/teach basic linear algebra}\\
\textbullet{Implements common 1-qubit gates, arbitrary 2-qubit control gates, arbitrary rotation}\\
\textbullet{Functions for checking if normed, unitary, hermitian, and generating Bell states}\\
\textbullet{Goal: Build circuit interface and perform QFT on my own simulated QC}\\
\textbf{tools:} Julia, LinearAlgebra.jl \\
\textbf{src :} github.com/anandijain/MyQuantum\\
