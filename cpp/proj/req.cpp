// NOT MINE 
// credit to connormanning/ https://gist.github.com/connormanning/41efa6075515019e499c
// g++ req.cpp -ljsoncpp -lcurl -o example.out && ./example.out
#include <cstdint>
#include <iostream>
#include <memory>
#include <string>
...
int main()
{
    const std::string url("https://www.bovada.lv/services/sports/event/v2/events/A/description/volleyball/brazil");
